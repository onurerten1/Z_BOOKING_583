CLASS zbp_generate_bookings_583 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zbp_generate_bookings_583 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA it_bookings TYPE TABLE OF ztbooking_583.
    ...
    DELETE FROM ztbooking_583.
    " insert the new table entries
    INSERT ztbooking_583 FROM TABLE @it_bookings.

    " check the result
    SELECT * FROM ztbooking_583 INTO TABLE @it_bookings.
    out->write( sy-dbcnt ).
